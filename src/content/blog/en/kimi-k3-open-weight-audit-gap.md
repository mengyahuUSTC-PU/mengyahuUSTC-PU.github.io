...
This isn't Moonshot's first release under this pattern. K2.5 pulled in nearly 100,000 downloads in its first week and reached 3.5 million monthly downloads by March — meaning the model had already been deployed at scale in production for months before the first real independent safety evaluation appeared. That report, led by Zheng-Xin Yong and Parv Mahajan at Constellation with contributors from Brown, Imperial College London, University of Toronto, Oxford, and a dozen-plus other institutions, plus researchers from the Anthropic Fellows Program, didn't hit arXiv until April ([arXiv:2604.03121](https://arxiv.org/abs/2604.03121)).
