...
**One line for today**: both ends of the content ecosystem switched tracks on the same day: on the production side, a third of new webpages involve AI; on the distribution side, Google now routes visibility through readers' explicit choices. When text alone can no longer prove value, being deliberately chosen by a human is the strongest signal left.