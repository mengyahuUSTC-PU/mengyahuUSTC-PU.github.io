...
论文全文在 SAGE 付费墙后，我没能打开核对全文数据。以下具体数字来自本-古里安大学讲师 Sebastian Ben-Daniel [对论文的转述](https://thepalestineproject.medium.com/black-box-warfare-human-judgment-and-military-decision-making-in-the-age-of-ai-0d04076846fd)：全部场景平均批准率 65%；「AI 还是人类起草」这个标签对批准率的影响很小，当系统附上建议理由时影响完全消失。真正预测批准与否的是审批者自己的特质：复仇倾向量表得分与批准决定的相关系数 0.49，政治立场 0.39。从复仇倾向最低到最高的参与者，批准率从约 38% 升到约 78%；从政治立场最左到最右，批准率从约 31% 升到约 80%。
