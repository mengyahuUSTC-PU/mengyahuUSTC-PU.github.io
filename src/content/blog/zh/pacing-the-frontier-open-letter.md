...
把具体情节抽掉，这件事留下了一件比它本身更耐用的小工具。下一封公开信来的时候，问三个问题：它到底要求什么、有没有期限？签名的是谁——是不是仍然在职、敢用真名的内部人？签这个名，每个签署者要付出什么代价？2023 年的暂停信第一题得分很高、第二题很低；CAIS 声明第二题很高、第一题几乎为零；而这封信之所以能把第二题拿满，恰恰是因为第三题的答案是「几乎没有」。

由此得出一条值得留着的折扣规则：签名名单是「这份担忧有多普遍」的强证据，却是「担忧有多深」的弱证据。1273 个名字告诉你，对自动化 AI 研发的担忧如今在前沿实验室内部已是常态立场，由管研究的人公开持有，而不是离职路上才敢低声说的边缘观点；但它们完全没告诉你，其中有多少人愿意接受一场让自己搭上项目和股票的减速。这是两个不同的命题，而公开信常常被当作第二个命题的证明来展示——它们其实只证明了第一个。

同样的折扣反过来也适用于这个故事里嵌着的硬证据。无论这封信最终命运如何，它背后那组自动化数据（80% 合入代码由 Claude 编写、工程师日合入代码量是过去的 8 倍）是一家公司对自己的披露——前一个数字有违它的宣传利益，后一个数字附带了它自己声明的保留。对想判断自动化 AI 研发到底走到哪一步的从业者来说，这些数字比 1273 个签名加起来都值钱。
