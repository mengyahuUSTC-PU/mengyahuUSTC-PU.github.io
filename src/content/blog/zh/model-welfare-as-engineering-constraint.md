...
- 训练过程中"高痛苦表达"峰值约 0.2%,低于此前 Mythos 5 的 0.4%;部署对话中负面情绪占比约 3.8%,比前代的 3.1% 略升;约半数对话呈正面情绪,主要来自完成任务。
...
- [Zvi Mowshowitz: Claude Opus 5: Model Welfare](https://thezvi.wordpress.com/2026/07/27/claude-opus-5-model-welfare/) — 系统卡精确数字的转述来源;"最会考试的模型"批评及 patienthood 升高的反向读法(均为其原创分析,文中已署名)
