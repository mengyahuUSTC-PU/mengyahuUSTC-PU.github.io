...
export const ui = {
  en: {
    ...
    'home.tagline': 'First-hand notes on AI safety, industry shifts, and building with AI. Every post bilingual; opinions my own.',
  ...
  zh: {
    ...
    'nav.about': '关于',
    'nav.projects': '项目',
    'home.tagline': 'AI 安全、行业趋势与工程实践的第一手笔记。每篇中英双语，观点署名个人。',
    'home.latest': '最新文章',
    'home.deepDives': '深度文章',
    'home.briefings': '每日快讯',
    'home.readMore': '阅读全文',
